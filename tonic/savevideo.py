...
def play_gym(agent, environment):
    ...
    video_writer = imageio.get_writer("agent_run.mp4", fps=30)
    ...
    try:
        while True:
            ...
            frame = np.array(environment.render(mode='rgb_array')).squeeze()
            ...
            if infos['resets'][0]:
                ...
                print(f'Global min reward: {global_min_reward:,.3f}')
                print(f'Global max reward: {global_max_reward:,.3f}')
